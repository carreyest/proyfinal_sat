<?php
class clsNewIncludablePage1 { //NewIncludablePage1 class @1-44430D68
...
//Class_Initialize Event @1-A2D7AECA
    function clsNewIncludablePage1($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "NewIncludablePage1.php";
        $this->Redirect = "";
        $this->TemplateFileName = "NewIncludablePage1.html";
...
} //End NewIncludablePage1 Class @1-FCB6E20C
