...
">
			<Components>
				<Label id="59" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="l_calificacion_incidentes_TotalRecords" wizardUseTemplateBlock="False" PathID="l_calificacion_incidentesl_calificacion_incidentes_TotalRecords" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events>
				...
				<Sorter id="61" visible="True" name="Sorter_contador" column="contador" wizardCaption="Contador" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="contador" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_contador" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="62" visible="True" name="Sorter_id_incidencia" column="id_incidencia" wizardCaption="Id Incidencia" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="id_incidencia" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_id_incidencia" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="63" visible="True" name="Sorter_servicio_de_negocio" column="servicio_de_negocio" wizardCaption="Servicio De Negocio" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="servicio_de_negocio" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_servicio_de_negocio" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="64" visible="True" name="Sorter_nombre_del_producto" column="nombre_del_producto" wizardCaption="Nombre Del Producto" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="nombre_del_producto" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_nombre_del_producto" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="65" visible="True" name="Sorter_severidad" column="severidad" wizardCaption="Severidad" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="severidad" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_severidad" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="66" visible="True" name="Sorter_Cumple_Inc_TiempoAsignacion" column="Cumple_Inc_TiempoAsignacion" wizardCaption="Cumple Inc Tiempo Asignacion" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="Cumple_Inc_TiempoAsignacion" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_Cumple_Inc_TiempoAsignacion" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="67" visible="True" name="Sorter_Cumple_Inc_TiempoSolucion" column="Cumple_Inc_TiempoSolucion" wizardCaption="Cumple Inc Tiempo Solucion" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="Cumple_Inc_TiempoSolucion" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_Cumple_Inc_TiempoSolucion" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="68" visible="True" name="Sorter_Obs_Proceso" column="Obs_Proceso" wizardCaption="Obs Proceso" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="Obs_Proceso" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_Obs_Proceso" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="69" visible="True" name="Sorter_fecha_registro" column="fecha_registro" wizardCaption="Fecha Registro" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="fecha_registro" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_fecha_registro" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Sorter id="70" visible="True" name="Sorter_tipo_carga" column="tipo_carga" wizardCaption="Tipo Carga" wizardTheme="Austere4" wizardSortingType="Extended" wizardControl="tipo_carga" wizardAddNbsp="False" PathID="l_calificacion_incidentesSorter_tipo_carga" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Sorter>
				<Label id="71" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="contador" fieldSource="contador" wizardCaption="Contador" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="False" PathID="l_calificacion_incidentescontador" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="72" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="id_incidencia" fieldSource="id_incidencia" wizardCaption="Id Incidencia" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesid_incidencia" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="73" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="servicio_de_negocio" fieldSource="servicio_de_negocio" wizardCaption="Servicio De Negocio" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesservicio_de_negocio" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="74" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="nombre_del_producto" fieldSource="nombre_del_producto" wizardCaption="Nombre Del Producto" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesnombre_del_producto" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="75" fieldSourceType="DBColumn" dataType="Integer" html="False" generateSpan="False" name="severidad" fieldSource="severidad" wizardCaption="Severidad" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAlign="right" wizardAddNbsp="False" PathID="l_calificacion_incidentesseveridad" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="76" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="Cumple_Inc_TiempoAsignacion" fieldSource="Cumple_Inc_TiempoAsignacion" wizardCaption="Cumple Inc Tiempo Asignacion" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesCumple_Inc_TiempoAsignacion" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="77" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="Cumple_Inc_TiempoSolucion" fieldSource="Cumple_Inc_TiempoSolucion" wizardCaption="Cumple Inc Tiempo Solucion" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesCumple_Inc_TiempoSolucion" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="78" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="Obs_Proceso" fieldSource="Obs_Proceso" wizardCaption="Obs Proceso" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesObs_Proceso" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="79" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="fecha_registro" fieldSource="fecha_registro" wizardCaption="Fecha Registro" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentesfecha_registro" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="80" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="tipo_carga" fieldSource="tipo_carga" wizardCaption="Tipo Carga" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_incidentestipo_carga" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Navigator id="81" size="10" type="Simple" pageSizes="1;5;10;25;50" name="Navigator" wizardPagingType="Simple" wizardFirst="True" wizardFirstText="Inicio" wizardPrev="True" wizardPrevText="Anterior" wizardNext="True" wizardNextText="Siguiente" wizardLast="True" wizardLastText="Final" wizardImages="Images" wizardPageNumbers="Simple" wizardSize="10" wizardTotalPages="True" wizardHideDisabled="False" wizardOfText="de" wizardPageSize="True" wizardTheme="Austere4" wizardImagesScheme="{ccs_style}" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="293" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="294" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="295" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		...
		<Grid id="99" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="20" name="l_detalle_medicion_apertu" connection="con_xls" dataSource="SELECT a.* 
...
ORDER BY a.contador" pageSizeLimit="100" pageSize="True" wizardCaption=" L Detalle Medicion Apertura Lista de" wizardTheme="Austere4" wizardThemeApplyTo="Component" wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Controls" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="False" gridTotalRecords="True" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="l_detalle_medicion_apertu" wizardThemeVersion="3.0">
			<Components>
				...
				<Label id="130" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="req_serv" fieldSource="req_serv" wizardCaption="Req Serv" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_apertureq_serv" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="131" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="fecha_asignacion" fieldSource="fecha_asignacion" wizardCaption="Fecha Asignacion" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_apertufecha_asignacion" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="132" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="fecha_entrega_prop" fieldSource="fecha_entrega_prop" wizardCaption="Fecha Entrega Prop" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_apertufecha_entrega_prop" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="133" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="fecha_acepta_prop" fieldSource="fecha_acepta_prop" wizardCaption="Fecha Acepta Prop" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_apertufecha_acepta_prop" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="296" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="297" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="298" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Grid>
		<Grid id="160" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="20" name="l_detalle_medicion_cierre" connection="con_xls" dataSource="SELECT a.* 
...
ORDER BY a.contador" pageSizeLimit="100" pageSize="True" wizardCaption=" L Detalle Medicion Cierre Lista de" wizardTheme="Austere4" wizardThemeApplyTo="Component" wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Controls" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="False" gridTotalRecords="True" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="l_detalle_medicion_cierre" wizardThemeVersion="3.0">
			<Components>
				...
				<Label id="194" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="cump_req_func" fieldSource="cump_req_func" wizardCaption="Cump Req Func" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierrecump_req_func" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="196" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="retraso_entregables" fieldSource="retraso_entregables" wizardCaption="Retraso Entregables" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierreretraso_entregables" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="198" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="calidad_prod_term" fieldSource="calidad_prod_term" wizardCaption="Calidad Prod Term" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierrecalidad_prod_term" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="202" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="calidad_codigo" fieldSource="calidad_codigo" wizardCaption="Calidad Codigo" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierrecalidad_codigo" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="204" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="defectos_fugados_amb_prod" fieldSource="defectos_fugados_amb_prod" wizardCaption="Defectos Fugados Amb Prod" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierredefectos_fugados_amb_prod" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				...
				<Label id="212" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="fecha_registro" fieldSource="fecha_registro" wizardCaption="Fecha Registro" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_cierrefecha_registro" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="299" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="300" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="301" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Grid>
		<Grid id="221" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="20" name="l_detalle_medicion_inc" connection="con_xls" dataSource="SELECT a.* 
...
ORDER BY a.contador" pageSizeLimit="100" pageSize="True" wizardCaption=" L Detalle Medicion Inc Lista de" wizardTheme="Austere4" wizardThemeApplyTo="Component" wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Controls" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="False" gridTotalRecords="True" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="l_detalle_medicion_inc" wizardThemeVersion="3.0">
			<Components>
				...
				<Label id="249" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="nuevo" fieldSource="nuevo" wizardCaption="Nuevo" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incnuevo" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="250" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="asignado" fieldSource="asignado" wizardCaption="Asignado" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incasignado" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="251" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="en_curso" fieldSource="en_curso" wizardCaption="En Curso" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incen_curso" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="252" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="pendiente" fieldSource="pendiente" wizardCaption="Pendiente" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incpendiente" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="253" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="resuelto" fieldSource="resuelto" wizardCaption="Resuelto" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incresuelto" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="254" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="cerrado" fieldSource="cerrado" wizardCaption="Cerrado" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_inccerrado" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="255" fieldSourceType="DBColumn" dataType="Date" html="False" generateSpan="False" name="fecha_entrega_avl" fieldSource="fecha_entrega_avl" wizardCaption="Fecha Entrega Avl" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incfecha_entrega_avl" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="256" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="manejo_incid_tiempo_atencion" fieldSource="manejo_incid_tiempo_atencion" wizardCaption="Manejo Incid Tiempo Atencion" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_medicion_incmanejo_incid_tiempo_atencion" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="302" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="303" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="304" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Grid>
		<Grid id="264" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="20" name="l_detalle_eficiencia_pres" connection="con_xls" dataSource="SELECT a.* 
...
ORDER BY a.contador" pageSizeLimit="100" pageSize="True" wizardCaption=" L Detalle Eficiencia Presupuestal Lista de" wizardTheme="Austere4" wizardThemeApplyTo="Component" wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Controls" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="False" gridTotalRecords="True" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="l_detalle_eficiencia_pres" wizardThemeVersion="3.0">
			<Components>
				...
				<Label id="284" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="efic_presupuestal" fieldSource="efic_presupuestal" wizardCaption="Efic Presupuestal" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_detalle_eficiencia_presefic_presupuestal" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="305" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="306" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="307" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
		</Grid>
		<Grid id="308" secured="False" sourceType="SQL" returnValueType="Number" defaultPageSize="20" name="l_calificacion_rs_AUT" connection="con_xls" dataSource="
SELECT a.* 
...
ORDER BY a.contador" pageSizeLimit="100" pageSize="True" wizardCaption="Grid1" wizardTheme="Austere4" wizardThemeApplyTo="Component" wizardGridType="Tabular" wizardSortingType="Extended" wizardAllowInsert="False" wizardAltRecord="False" wizardAltRecordType="Controls" wizardRecordSeparator="False" wizardNoRecords="No hay registros" wizardGridPagingType="Simple" wizardUseSearch="False" wizardAddNbsp="False" gridTotalRecords="True" wizardAddPanels="False" wizardType="Grid" wizardUseInterVariables="False" addTemplatePanel="False" changedCaptionGrid="False" gridExtendedHTML="False" PathID="l_calificacion_rs_AUT" wizardThemeVersion="3.0">
			<Components>
				...
				<Label id="338" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="herr_est_cost" fieldSource="herr_est_cost" wizardCaption="Herr Est Cost" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTherr_est_cost" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="339" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="req_serv" fieldSource="req_serv" wizardCaption="Req Serv" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTreq_serv" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="340" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="cumpl_req_func" fieldSource="cumpl_req_func" wizardCaption="Cumpl Req Func" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTcumpl_req_func" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="341" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="retr_entregable" fieldSource="retr_entregable" wizardCaption="Retr Entregable" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTretr_entregable" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="342" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="calidad_prod_term" fieldSource="calidad_prod_term" wizardCaption="Calidad Prod Term" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTcalidad_prod_term" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="343" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="calidad_codigo" fieldSource="calidad_codigo" wizardCaption="Calidad Codigo" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTcalidad_codigo" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
				</Label>
				<Label id="344" fieldSourceType="DBColumn" dataType="Text" html="False" generateSpan="False" name="def_fug_amb_prod" fieldSource="def_fug_amb_prod" wizardCaption="Def Fug Amb Prod" wizardIsPassword="False" wizardUseTemplateBlock="False" wizardAddNbsp="False" PathID="l_calificacion_rs_AUTdef_fug_amb_prod" wizardTheme="Austere4" wizardThemeVersion="3.0">
					<Components/>
					<Events/>
					<Attributes/>
					<Features/>
			...
			<SPParameters/>
			<SQLParameters>
				<SQLParameter id="349" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
				<SQLParameter id="350" dataType="Integer" defaultValue="0" parameterSource="s_id_periodo" parameterType="URL" variable="s_id_periodo"/>
				<SQLParameter id="351" dataType="Text" parameterSource="s_opt_slas" parameterType="URL" variable="s_opt_slas"/>
			</SQLParameters>
			<SecurityGroups/>
			<Attributes/>
			<Features/>
...
FROM usuario " boundColumn="id_proveedor" textColumn="nom_proveedor">
					<Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
				...
				<ListBox id="355" visible="Yes" fieldSourceType="DBColumn" sourceType="SQL" dataType="Text" returnValueType="Number" name="s_id_periodo" wizardTheme="Austere4" wizardThemeType="File" wizardThemeVersion="3.0" wizardEmptyCaption="Seleccionar Valor" PathID="l_calificacion_incidentes1s_id_periodo" connection="con_xls" dataSource="select id_periodo,  nombre_mes+'/'+convert(varchar,anio,1) as periodo
from periodos_carga p
where convert(timestamp,p.fecha_limite,120)&gt;=convert(timestamp,getDATE(),120)
and mes&lt;=month(getDATE())
and (id_proveedor=0 or id_proveedor={s_id_proveedor} )"><Components/>
					<Events/>
					<TableParameters/>
					<SPParameters/>
					<SQLParameters>
						<SQLParameter id="357" dataType="Integer" defaultValue="0" parameterSource="s_id_proveedor" parameterType="URL" variable="s_id_proveedor"/>
					</SQLParameters>
					<JoinTables/>
					<JoinLinks/>
					<Fields/>
