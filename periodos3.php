<?php
//Include Common Files @1-3FB568C2
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "periodos3.php");
...
//Class_Initialize Event @3-E37036D0
    function clsGridperiodos_carga($RelativePath, & $Parent)
    {
        ...
        $this->periodos_carga_Insert->Page = "periodos3.php";
...
//DataSourceClass_Initialize Event @3-07D50A96
...
//Class_Initialize Event @36-83C8D649
...
//CheckErrors Method @36-9B545818
...
//Operation Method @36-70637047
    function Operation()
    {
        ...
        $Redirect = "periodos3.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "periodos3.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
class clsRecordperiodos_carga1 { //periodos_carga1 Class @42-53EC4D85
...
//Class_Initialize Event @42-888775DA
    function clsRecordperiodos_carga1($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->fecha_limite = new clsControl(ccsTextBox, "fecha_limite", "Fecha Limite", ccsDate, array("dd", "/", "mm", "/", "yyyy", " ", "hh", ":", "mm"), CCGetRequestParam("fecha_limite", $Method, NULL), $this);
...
//CheckErrors Method @42-F3E7D0CA
    function CheckErrors()
    {
        $errors = false;
...
} //End periodos_carga1 Class @42-FCB6E20C

class clsperiodos_carga1DataSource extends clsDBcon_xls {  //periodos_carga1DataSource Class @42-9F90EC5C

//DataSource Variables @42-1513837D
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @42-2400F00F
...
} //End periodos_carga1DataSource Class @42-FCB6E20C

//Include Page implementation @105-3DD2EFDC
include_once(RelativePath . "/Header.php");
//End Include Page implementation

//Initialize Page @1-FDE4831F
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "periodos3.html";
$BlockToParse = "main";
...
//Include events file @1-FB90D86F
include_once("./periodos3_events.php");
...
// Controls
$Panel12 = new clsPanel("Panel12", $MainPage);
$Panel12->GenerateDiv = true;
$Panel12->PanelId = "Panel12";
...
$Panel12->AddComponent("periodos_carga", $periodos_carga);
$Panel12->AddComponent("periodos_cargaSearch", $periodos_cargaSearch);
$Panel12->AddComponent("Panel2", $Panel2);
